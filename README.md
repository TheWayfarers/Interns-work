...
Daily practice repo for learning **Web, React, and Node** — and Git along the way.
...
Your folder: `interns/<your-name>/`

## Git rules (short)

- Always create branches **from `master`** — run `git pull` first
- Do **not** commit or push directly to `master`
- Branch name: `intern/<your-name>/task-01-expense-tracker` (match the task)
...
- Basics tasks → [practices/](practices/)
