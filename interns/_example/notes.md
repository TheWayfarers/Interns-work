...
- `git clone` — download the repo to your laptop
...
- Arrays — `map`, `filter`, `forEach` for lists
- Objects — store related data as key-value pairs
- DOM — JavaScript that changes the webpage in the browser
- `async/await` — handle code that takes time (API calls, delays)
